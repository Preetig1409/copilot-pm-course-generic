#!/usr/bin/env node
/**
 * Static Site Generator for Copilot PM Course
...
// ─── Course Structure (mirrored from viewer/src/data/courseStructure.ts) ───

const levels = [
  {
    id: '1', title: 'Foundation', description: 'Core Copilot skills for PMs',
    modules: [
      { id: '1.1', title: 'Welcome to Microsoft Copilot', duration: '15 min', path: 'lesson-modules/1-fundamentals/1.1-welcome/MODULE.md' },
      { id: '1.2', title: 'Setting Up Your Workspace', duration: '15 min', path: 'lesson-modules/1-fundamentals/1.2-workspace-setup/MODULE.md' },
      { id: '1.3', title: 'Your First PM Tasks', duration: '30 min', path: 'lesson-modules/1-fundamentals/1.3-first-tasks/MODULE.md' },
      { id: '1.4', title: 'Using Researcher & Analyst Agents', duration: '25 min', path: 'lesson-modules/1-fundamentals/1.4-researcher-analyst-agents/MODULE.md' },
      { id: '1.5', title: 'Persona Prompting for Different Perspectives', duration: '20 min', path: 'lesson-modules/1-fundamentals/1.5-persona-prompting/MODULE.md' },
      { id: '1.6', title: 'Building Context with Memory', duration: '15 min', path: 'lesson-modules/1-fundamentals/1.6-copilot-memory/MODULE.md' },
      { id: '1.7', title: 'Copilot Across M365 Apps', duration: '15 min', path: 'lesson-modules/1-fundamentals/1.7-m365-navigation/MODULE.md' },
      { id: '1.8', title: 'Copilot in Microsoft Teams', duration: '25 min', path: 'lesson-modules/1-fundamentals/1.8-teams-integration/MODULE.md' },
      { id: '1.9', title: 'Copilot in Outlook', duration: '20 min', path: 'lesson-modules/1-fundamentals/1.9-outlook-integration/MODULE.md' },
      { id: '1.10', title: 'Copilot in SharePoint & Collaboration', duration: '20 min', path: 'lesson-modules/1-fundamentals/1.10-sharepoint-collaboration/MODULE.md' },
    ]
  },
  {
    id: '2', title: 'Advanced PM Workflows', description: 'Complex PM tasks with Copilot',
    modules: [
      { id: '2.1', title: 'Writing PRDs with Copilot', duration: '35 min', path: 'lesson-modules/2-advanced-pm-work/2.1-write-prd/MODULE.md' },
      { id: '2.2', title: 'Analyzing Product Data', duration: '30 min', path: 'lesson-modules/2-advanced-pm-work/2.2-analyze-data/MODULE.md' },
      { id: '2.3', title: 'Product Strategy', duration: '30 min', path: 'lesson-modules/2-advanced-pm-work/2.3-product-strategy/MODULE.md' },
    ]
  },
  {
    id: '3', title: 'Product Visuals', description: 'Creating visuals with DALL-E and Designer',
    modules: [
      { id: '3.1', title: 'Image Generation Basics', duration: '20 min', path: 'lesson-modules/3-product-visuals/3.1-image-basics/MODULE.md' },
      { id: '3.2', title: 'PM Visuals', duration: '25 min', path: 'lesson-modules/3-product-visuals/3.2-pm-visuals/MODULE.md' },
    ]
  }
];
...
// ─── All modules flat list for prev/next navigation ───

const allModules = levels.flatMap(l => l.modules);

// ─── CSS Styles (self-contained, no external dependencies) ───
...
.module-id {
  ...
  min-width: 2.5rem; font-size: 0.95rem;
}
.module-info { flex: 1; }
...
.resource-link:hover {
  border-color: var(--teal-border); color: var(--teal-dark);
...
.content h2 {
  ...
  color: var(--teal-dark); margin: 2.5rem 0 0.75rem;
...
.content code {
  background: var(--cream-dark); color: var(--teal-dark);
...
.content hr {
  border: none; border-top: 1px solid var(--cream-darker);
  margin: 2rem 0;
}
...
.nav-btn.next {
  ...
  border: 1px solid var(--teal); margin-left: auto;
}
...
<head>
  ...
  <title>${escapeHtml(title)} - Copilot PM Course</title>
  <style>${CSS}</style>
</head>
<body>
  <header class="site-header">
    <div class="header-inner">
      <a href="index.html" class="header-brand">Copilot for PMs</a>
  ...
  <footer class="site-footer">
    Copilot for Product Managers &middot; v2.0 &middot; Internal Training Material
  </footer>
</body>
</html>`;
}
...
// ─── Generate filename from module/resource ───
...
function buildIndexPage() {
  ...
  const body = `
    <div class="hero">
      <h1>Microsoft Copilot for Product Managers</h1>
      <p class="subtitle">A hands-on course to save 5-8 hours per week on core PM tasks using AI in your workflow</p>
      <p class="meta">
        <span>Self-Paced</span> &middot;
        <span>${totalModules} Modules</span> &middot;
        <span>${totalDuration}</span> &middot;
        <span>v2.0</span>
      </p>
    </div>
...
function build() {
  ...
  for (const section of resources) {
    for (const file of section.files) {
      const html = buildResourcePage(file, section.title);
  ...
  console.log(`\nOpen static-site/index.html in your browser to view the course.`);
}

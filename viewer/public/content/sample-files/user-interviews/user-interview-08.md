...
**Role:** VP Knowledge & Innovation
**Location:** New York, NY
**Tenure:** 22 years at NovaTech Solutions
**Responsibility:** Executive sponsor for KnowledgeHub
**Products Used:** KnowledgeHub (occasional, receives reports)
...
Richard is the VP Knowledge & Innovation and executive sponsor for KnowledgeHub. He's responsible for knowledge strategy across NovaTech Solutions and reports to the CEO on knowledge management initiatives. He provides the executive perspective on internal product investments and adoption challenges.

---

## Interview

**Q: What's your vision for KnowledgeHub?**

Richard: "Simply put: any NovaTech Solutions employee should be able to find any expert or any knowledge asset in under 5 minutes. Today it takes hours, sometimes days. We have 5,000 people creating incredible work, and most of it is invisible. We're paying the cost of reinvention every single day."

**Q: What does that cost look like?**

Richard: "We did a study. Conservative estimate: $200 million per year in duplicated effort. Engineers recreating proposals, analyses, frameworks that already exist. That's not even counting the opportunity cost - deals we lose because we can't mobilize expertise fast enough. The Monday.com deal Sarah Mitchell mentioned? That's $20 million we lost because we couldn't identify a blockchain expert in 48 hours."

**Q: Why hasn't KnowledgeHub solved this already?**
...
Richard: "We have a credibility problem. Engineers have tried KnowledgeHub, it's failed them, they've given up. Getting them to try again requires marketing, training, executive sponsorship - the whole change management apparatus. And it requires the product to actually work this time. If we launch AI search and it's mediocre, we've spent our credibility. We don't get another chance."

**Q: How do you think about ROI for these investments?**

Richard: "Every hour a team member saves searching for content is an hour they can bill to a client. If we save 4 hours per week per team member who uses KnowledgeHub, and we have 3,000 weekly users, that's 1.2 million hours per week. At average billing rates, that's enormous value. Plus the qualitative benefits: better proposals win more deals, faster expert mobilization wins competitive situations, happier team members means lower attrition."

**Q: What keeps you up at night about this initiative?**

Richard: "Two things. First, execution. We've launched 'improved search' before. It didn't work. The team needs to actually deliver this time. Second, adoption. We can build great features, but if team members don't use them, it doesn't matter. Change management is as important as product development. They need to work in parallel."
...
Richard: "Real. Atlassian's knowledge center is legendary. Monday.com is investing heavily in AI-powered tools. Even Notion is modernizing. Our team members compare us to competitors constantly. 'At Atlassian, I could find anything.' I hear that all the time. We have scale advantages - more content, more experts, more reach. But scale is only an advantage if we can leverage it. Right now, scale is a liability because we can't navigate it."

**Q: Final message for the team?**

Richard: "This matters. Not just for metrics, but for our people. Engineers are frustrated. They want tools that work. They want to find expertise, not recreate wheels. If we fix this, we make their lives better, we make the company more competitive, we reduce waste. It's rare that a product investment has this much potential impact. Don't waste the opportunity."
...
- Credibility problem: Past failures mean team members have given up on KnowledgeHub
...
- Competitive pressure: Atlassian, Monday.com, even Notion ahead or investing heavily
